...
async def seed_default_secrets_provider(session: AsyncSession) -> bool:
    ...
    creds, or a default already exists). Caller commits.
    """
    if not os.environ.get("OPENBAO_ROLE_ID"):
